...
#define EVENT_CHECK_LIST CheckKeyboard, CheckClock
...
#define SERV_0_HEADER "TimerFSM.h"
// the name of the Init function
#define SERV_0_INIT InitTimerFSM
// the name of the run function
#define SERV_0_RUN RunTimerFSM
