...
// These addresses are the same for all modules and can be used to identify
// what type of module it is. etc.
...
// These parameters are stored on the Timer, then replicated to all the modules
